...
bool DX11ModelDemo::LoadContent()
{
	...
	m_radius = 200;
	//加载模型数据
	model_ = new ObjModel(new ModelObj("C:\\Users\\tanpan\\Desktop\\model\\XJC\\model.obj"),D3D11Device_);		//树
	//model_ = new ObjModel(new ModelObj("C:\\Users\\tanpan\\Desktop\\model\\09\\saloon.obj"),D3D11Device_);	//汽车
